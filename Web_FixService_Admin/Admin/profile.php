...
<div class="col-md-4">
<center><img class="img-profile rounded-circle" src="resource/<?php echo $profile['foto'] ?>" alt="Gambar Profile" width="150px" height="150px"></center>
<p><b><center><?php echo $profile['username'] ?></center></b></p>
</div>
