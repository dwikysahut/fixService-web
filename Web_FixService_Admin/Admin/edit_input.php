   ...
   $rrr = mysqli_fetch_array($sss);
        ...
        <!-- End of Topbar -->
              ...
              <?php
                ...
                $det=mysqli_query($conn, "select * from keluar where id = '$namab'");
...
<div class="col-md-6">
  <input type="number" class="form-control" placeholder="Jumlah Barang..." value='<?php echo $d['JumlahB'] ?>' name='jumlah' required>
...
<?php } }?>
            ...
            <?php
              ...
              if(isset($_POST['edit'])){
               ...
               $namab= htmlspecialchars($_POST['jenis']);
               $juml= htmlspecialchars($_POST['jumlah']);

               //ini bagian ambil harga jual di awal data//
                $bil=mysqli_query($conn, "select * from masuk where nama = '$namab'");
                $fft= mysqli_fetch_array($bil);
                $sus = $fft['hargaJ'];
             ...
             $edit = mysqli_query($conn, "UPDATE keluar SET
